...
def get_argparse():
    ...
    parser.add_argument("--pgd",  default=False, action="store_true",
                        help="whether train attack")
    parser.add_argument("--train_dataset", default='NER_train_0.txt', type=str)
    parser.add_argument("--dev_dataset", default='NER_dev_0.txt', type=str)
    parser.add_argument("--test_dataset", default='NER_test.txt', type=str)
    return parser